  ...
  return (
    <div className="home">
      <div className="home-container">
        <img
          src="https://images-eu.ssl-images-amazon.com/images/G/31/prime/PD23/ACQ/hero/day2/PC_Hero_1500x600_KV_DAY_OFF_FT._CB599831663_.jpg"
          alt=""
        ...
        <div className="home-row">
          <Product
            ...
            price={1094.98}
            rating={4}
            image="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS1NCpdAFHN6QS7LvZrX4UrhlbiGwtON8vF3m7NBtW1tjwPQrQu_t3fEt0XvSpuq-4CliU&usqp=CAU"
          />
        </div>
      </div>
    </div>
